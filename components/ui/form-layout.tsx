  ...
  return (
    <>
      <div className="bg-white rounded-[14px] border border-[#e9f2f9] shadow-[0_1px_3px_rgba(0,0,0,0.06)] p-6">
        ...
        <div className="flex items-center justify-end gap-3 mt-8 pt-5 border-t border-[#F1F5F9]">
          <button
            ...
            className="h-[38px] px-5 rounded-[8px] border border-[#E5E7EB] text-[13px] font-medium text-[#64748B] hover:bg-[#F8FAFC] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Cancelar
          </button>
          <button
            ...
            disabled={saving || isLoading}
            className="h-[38px] px-5 rounded-[8px] bg-[#3B82F6] text-white text-[13px] font-medium flex items-center gap-2 hover:bg-[#2563EB] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <Save size={14} />
            Salvar
          </button>
      ...
      <ConfirmModal
        ...
        descricao="Revise os dados antes de salvar"
        dados={formData}
        labelConfirm="Salvar"
        labelCancel="Voltar"
        isLoading={saving}
