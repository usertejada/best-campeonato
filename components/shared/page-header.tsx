    ...
    <div className="flex flex-col gap-3 mb-6 min-[640px]:flex-row min-[640px]:items-center min-[640px]:justify-between">
      ...
      {buttonLabel && (
        <Button
          ...
          className="bg-[#4F6BED] hover:bg-[#3D5BD9] text-white text-[13px] font-medium h-[38px] px-4 rounded-[8px] shrink-0 self-start min-[640px]:self-auto whitespace-nowrap"
        >
          {Icon && <Icon size={15} />}
          {buttonLabel}
        </Button>
